      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mt-8 mb-16">
          <FadeUp className="lg:col-span-7 space-y-6">
            ...
            <h1 className="text-4xl lg:text-5xl font-serif-elegant font-bold text-primary leading-tight">{service.name}</h1>
            <p className="text-foreground/80 text-base lg:text-lg font-light leading-relaxed">{service.longDescription}</p>
          </FadeUp>
